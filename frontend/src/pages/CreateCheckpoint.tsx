...
export function CreateCheckpoint({ pipelineId }: CreateCheckpointProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.createCheckpoint(pipelineId, {
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white shadow-sm rounded-lg border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Create Checkpoint</h1>
          ...
          >
            {submitting ? 'Creating...' : 'Save Checkpoint'}
          </button>
        </div>
